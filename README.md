...
```
가상 선택자 및 클래스 선택자 등 CSS 선택자 예제
```

### [210325 : 과제3](https://github.com/bh2980/20211_WebProgramming/tree/main/210325)
...
사용자가 서버에 request(요청)를 전송하면 서버에서 요청을 해석하고
사용자가 입력한 값이나 요청 주소를 확인하고
...
<%- include('layouts/header'); -%> 코드를 사용하여 공통적으로 들어가는 부분을 
각 ejs 파일들에 인클루드 시켜 나타낼 수 있다.
...
- 백엔드
 ...
 콤보박스 자바스크립트로 값 변경 : https://alvine.tistory.com/253
 ```
